...
Where things start to get tricky is with the next line: Nano. What this does is create an interface that allows the user to edit text in command line instead of going to the file manually. This temporarily takes you out of command line to do this, which intially may shock some users as the GUI isn't as intuitive as it really is. 

<img width="1440" alt="Screenshot 2023-04-02 at 11 15 21 PM" src="https://user-images.githubusercontent.com/98351265/229404623-4cce2366-d5ee-41f5-a582-867a6ab3185e.png">
